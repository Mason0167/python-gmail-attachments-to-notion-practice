...
def parse_USA_pdf(filedata, PDF_PASSWORD=None):
    # Wrap bytes in a file-like object
    pdf_buffer = io.BytesIO(filedata)

    with pdfplumber.open(pdf_buffer, password=PDF_PASSWORD) as pdf:
        # Extract Text
        text = ""
...
def parse_TW_pdf(filedata, filename, PDF_PASSWORD=None):
    pdf_buffer = io.BytesIO(filedata)
...
def parse_zip(filedata, filename, PDF_PASSWORD=None):
    zip_buffer = io.BytesIO(filedata)
